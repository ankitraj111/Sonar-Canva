...
const fov = 100; // ±50 degrees Field of View
const numCircles = 4;

// Beam configuration
const beamWidth = 8;
let beamAngle = -fov / 2;
const beamRotationSpeed = 0.15; // beam rotation speed
...
// Update trails (limit trail length for performance)
...
// Draw radar background and grid arcs
...
// Sonar info panel shows targets inside radar FOV
...
function animate() {
  ...
  // Uncomment below to enable rotating glowing beam
