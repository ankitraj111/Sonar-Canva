...
<body>
    ...
    <%
        ...
        // Example: list of GPS targets—all real logic server-side here.
        double[][] gpsTargets = {
            {19.990, 109.003},
            {19.992, 109.008}
        };
    %>
    <script>
        // Passing server-side variable to JS
...
// Assumes referencePosition and gpsTargets are defined in JSP
const CONFIG = {
  RADAR_WIDTH: 950,
  RADAR_HEIGHT: 480,
  FOV: 100,
